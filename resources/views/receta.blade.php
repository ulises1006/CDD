                ...
                <tr style="margin-top:-100px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px;margin:auto;">
                            <hr style="border-bottom: 0.5px solid black; width: 300px; margin-top: 140px; text-align:center;">
                            <h6 style="  margin-top: 10px; text-align:center;">FIRMA DEL MÉDICO</h6>
                        </div>
                    </th>
                </tr>
            </tbody>
        </table>
        <hr style="margin-top: 30px; width: 2000px; margin-left:-50px; border:1px dotted">
        <table>
            <thead>
                <tr style="margin-top:0px;">
            ...
            <tbody style="height:60px;padding-top:60px; !important">
                ...
                <tr style="margin-top:-100px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px;margin:auto;">
                            <hr style="border-bottom: 0.5px solid black; width: 300px; margin-top: 119px; text-align:center;">
                            <h6 style="  margin-top: 0px; text-align:center;">FIRMA DEL MÉDICO</h6>
                        </div>
                    </th>
                </tr>
        </table>
