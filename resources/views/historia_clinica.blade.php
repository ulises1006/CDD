    ...
    <div style="margin-top:-120px;padding:0; margin-left:0;" class="container">
        <table style="height:50%;">
            <thead>
                <tr style="margin-top:0px;">
                    <th style="margin-top:0px"><img width="700px" style="margin-top:80px;" src="../public/images/alberto.png"></th>
                </tr>
            </thead>
            <tbody style="height:60px;padding-top:60px; !important">
                <tr style="height:60px;padding-top:60px; !important">
                    <th class="" style="width:50%;text-align:right;">
                        <div style="height:60px;">
                            <p style="margin-top:25px;">Durango, Dgo. 24/01/2019</p>
                        </div>
                    </th>
                </tr>
                <tr style="margin-top:200px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px; margin-top: -15px">
                            ...
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Edna Guadalupe Castrellon Contreras
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                22 años &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr style="margin-top:-100px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px;">
                            <p style="margin-top:40px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dom/Con San
                                Jose de la Vinata Durango
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr style="margin-top:200px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px; margin-top: -15px">
                            <p style="margin-top: 60px;">Nombre de tutor: &nbsp;&nbsp;Edna Guadalupe Castrellon
                                Contreras
                ...
                <tr style="margin-top:200px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px; margin-top: -15px">
                            <p style="margin-top: 65px;">Parentesco: Edna Guadalupe Castrellon Contreras
                ...
                <tr style="margin-top:200px; height:60px;">
                    <th class="" style="width:20%;text-align:left;">
                        <div style="height:0px; margin-top: -15px">
                            <p style="margin-top: 60px;">Motivo de la consulta: &nbsp;&nbsp;Edna Guadalupe Castrellon
                                Contreras
        ...
        <table class="tabla" style="margin-top:60px;">
            ...
            <tr class="tr">
                ...
                <td class="td"></td>6
                <td class="td">Enfermedades cardiaca </td>
                <td class="td"></td>
            </tr>
            <tr class="tr">
        ...
        <p style="margin-top: 10px;">Alergias: Edna Guadalupe Castrellon Contreras
            <hr style="border-bottom: 0.5px solid black; width: 535px; margin-top: -15px; margin-right:129px;">
        </p>
        <p style="margin-top: 10px;">Problema dental previo: Edna Guadalupe Castrellon Contreras
        ...
        <hr style="border-bottom: 0.5px solid black; width: 300px; margin-top:120px; text-align:center;">
